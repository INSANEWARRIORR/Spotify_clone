...
const Login = () => {
  ...
  //Updates userDetails state dynamically as the user types into the input fields. Uses ES6 spread syntax to preserve existing state and update only the changed field.
  const onChange = (e) => {
      ...
      <div className="bg-[#1a1919] py-10 w-full">
        <div className="bg-black py-10 text-center w-1/2 mx-auto">
          <div className="logo flex justify-center">
            <Link to="/">
              <img src="/assets/Spotify_DarkGreen.png" width={200} alt="" />
            </Link>
          </div>
